...
def lambda_handler(event, context):
    ...
    url = (
        ...
        f"&with_origin_country=BR&with_genres=16&first_air_date.gte=2001-01-01"
    )
    seriesBrasileiras = []
    ...
    for pagina in range(1, 6):
        ...
        for tvShow in data.get("results", []):
            ...
            seriesBrasileiras.append({
                ...
                #Conteúdo da 3° url
                "Dubladores": ", ".join(dubladores) if dubladores else "Informação indisponível",
            })
        sleep(1)
...
def save_to_s3(data ):
    ...
    seriesKey = f"Raw/TMDB/JSON/{year}/{month}/{day}/SeriesBrasileirasAnimacao.json"
